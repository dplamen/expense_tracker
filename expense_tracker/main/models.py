...
from expense_tracker.validators import validate_letters_only, ValidateMaxSizeImage
...
class Profile(models.Model):
    ...
    budget = models.FloatField(default=BUDGET_DEFAULT_VALUE,
    ...
    profile_image = models.ImageField(upload_to='images',
                                      null=True,
                                      blank=True,
                                      validators=(ValidateMaxSizeImage(5),)
                                      )
