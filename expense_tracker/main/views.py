...
from expense_tracker.main.forms import CreateProfileForm, EditProfileForm, DeleteProfileForm, CreateExpenseForm, \
...
def create_expense(request):
    ...
    return render(request, 'main/expense-create.html', context)
...
def edit_expense(request, pk):
    ...
    return render(request, 'main/expense-edit.html', context)
...
def delete_expense(request, pk):
    ...
    return render(request, 'main/expense-delete.html', context)
